...
cd ..\..
@echo on
@echo === Running sbt --java-home "%JAVA8_HOME%" %* +sugar-tms/test >tmpTestAllScalaAllJDK.txt
call sbt --java-home "%JAVA8_HOME%" %* +sugar-tms/test >>tmpTestAllScalaAllJDK.txt
@echo === Running sbt --java-home "%JAVA11_HOME%" %* +sugar-tms/test >>tmpTestAllScalaAllJDK.txt
call sbt --java-home "%JAVA11_HOME%" %* +sugar-tms/test >>tmpTestAllScalaAllJDK.txt
@echo === Running sbt %* +sugar-tms/test === for default JDK %JAVA_HOME% >>tmpTestAllScalaAllJDK.txt
call sbt %* +sugar-tms/test >>tmpTestAllScalaAllJDK.txt
